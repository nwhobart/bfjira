...
def mock_deps(mocker):
    ...
    mocker.patch("bfjira.jira_utils.get_client", return_value=mock_jira)
    mocker.patch("bfjira.jira_utils.branch_name", return_value="feat/TKT-123-summary")
    mock_create_branch = mocker.patch("bfjira.git_utils.create_branch")
    mock_transition = mocker.patch("bfjira.jira_utils.transition_to_in_progress")
    mock_stash = mocker.patch("bfjira.git_utils.stash_changes")
    mock_pop = mocker.patch("bfjira.git_utils.pop_stash")
    mock_to_git_root = mocker.patch("bfjira.git_utils.to_git_root")
